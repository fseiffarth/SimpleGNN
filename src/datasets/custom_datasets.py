...
from datasets.custom_benchmarks.counting_rings import CountingRings
from datasets.custom_benchmarks.even_odd_rings import EvenOddRings
from datasets.custom_benchmarks.string_graphs import EvenPairs, ParityCheck, FirstChar, LastChar
from datasets.custom_benchmarks.long_rings import LongRings
from datasets.custom_benchmarks.node_classification_test import NodeClassificationTest
from datasets.custom_benchmarks.ring_diagonals import RingDiagonals
from datasets.custom_benchmarks.ring_transfer import RingTransfer
from datasets.custom_benchmarks.snowflakes import Snowflakes
