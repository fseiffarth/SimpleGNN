                        ...
                        if layer_yml['layer_type'] == 'invariant_based_convolution':
                            for property_id in range(property_combinations):
                                ...
                                for j in range(num_channels):
                                    channel_dict = {}
                                    channel_dict['bias'] = layer_yml['bias']
                                    channel_dict['activation'] = layer_yml.get('activation', None)
                                    channel_dict['activation_kwargs'] = layer_yml.get('activation_kwargs', {})
                                    label_dict = {}
                                    ...
                                    channel_dict['properties']['name'] = layer_yml['properties'][property_id]['name']
                                    channel_dict['properties']['values'] = layer_yml['properties'][property_id][
                                        'values']
                                    if layer_yml['properties'][property_id].get('cutoff', None) is not None:
                                        channel_dict['properties']['cutoff'] = layer_yml['properties'][property_id][
                                            'cutoff']
