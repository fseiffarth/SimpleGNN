        ...
        for head_id, head in enumerate(self.layer.layer_heads):
            ...
            for key in valid_property_values:
                ...
                for n in range(self.n_heads_per_label[head_id]):
                    ...
                    self.weight_offset_description.append({'head:': head_id, 'property': key, 'weights': num_weights})
                    self.weight_offset_description_text.append(f"Head {head_id} Property {key} has {num_weights} different weights")
