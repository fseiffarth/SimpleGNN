...
python experiments/base_paper/classification/tu/experiments_fair_real_world.py --num_threads $NUM_THREADS
python experiments/base_paper/classification/tu/experiments_standard_real_world.py --num_threads $NUM_THREADS
